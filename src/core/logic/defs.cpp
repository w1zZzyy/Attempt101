...
std::optional<CastleType> Castle::ByRookSquare(Color c, Square rook_sqr)
{
    if(c.is(WHITE)) 
    {
        switch (rook_sqr) {
...
Bitboard Castle::king_path() const noexcept
{
...
Bitboard Castle::clear_path() const noexcept
{
...
bool Castle::has_path() const noexcept
{
...
bool same_file(Square sq1, Square sq2) noexcept {return sq1 % 8 == sq2 % 8;}
bool same_rank(Square sq1, Square sq2) noexcept {return sq1 / 8 == sq2 / 8;}
